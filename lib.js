export function tarifas(consumo) {
  ...
  else if (  7  <= consumo && consumo <= 40  ) return Number( 0.25*(consumo-7)+1.75+1.60  ).toFixed(2);
  else if ( 41  <= consumo && consumo <= 50  ) return Number( 0.40*(consumo-40)+11.60      ).toFixed(2);
  else if ( 51  <= consumo && consumo <= 100 ) return Number( (0.75*consumo)+1.60         ).toFixed(2);
  else if ( 101 <= consumo && consumo <= 150 ) return Number( (1.00*consumo)+1.60         ).toFixed(2);
  else if ( 151 <= consumo && consumo <= 200 ) return Number( (1.25*consumo)+1.60         ).toFixed(2);
  else if ( consumo >= 201) return (1.50*consumo)+1.60
  return 2.61
}
